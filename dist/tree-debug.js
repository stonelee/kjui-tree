define("kjui/tree/1.1.0/tree-debug", [ "$-debug", "kjui/grid/1.3.0/grid-debug", "arale/widget/1.0.3/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "arale/widget/1.0.3/templatable-debug", "gallery/handlebars/1.0.0/handlebars-debug", "gallery/underscore/1.4.4/underscore-debug", "./row-debug.tpl" ], function(require, exports, module) {
    var $ = require("$-debug"), Grid = require("kjui/grid/1.3.0/grid-debug"), Handlebars = require("gallery/handlebars/1.0.0/handlebars-debug"), _ = require("gallery/underscore/1.4.4/underscore-debug");
    var rowTpl = require("./row-debug.tpl");
...
define("kjui/tree/1.1.0/row-debug.tpl", [], '<tr class="grid-row" data-id="{{id}}" {{#if expanded}}data-status="expanded"{{/if}} {{#if leaf}}data-role="leaf"{{else}}data-role="expander"{{/if}}>\n  <td class="grid-cell">\n    {{#each icons}}<i class="icon-tree-{{this}}"></i>{{/each}}<span data-role="text" class="tree-item">{{name}}</span>\n  </td>\n  {{#each grids}}\n    <td class="grid-cell"{{#if align}} style="text-align:{{align}};"{{/if}}>\n      {{{value}}}\n    </td>\n  {{/each}}\n</tr>\n');
